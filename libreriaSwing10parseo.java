...
public class libreriaSwing10parseo extends JFrame implements ActionListener{
    private JTextField textfield1, textfield2;
    private JLabel label1, label2, label3;
    private JButton boton1;

    public libreriaSwing10parseo(){
        setLayout(null);
...
label3.setText("resultado: " + resultado);
    ...
    public static void main(String args[]){
        libreriaSwing10parseo formulario1 = new libreriaSwing10parseo();
        formulario1.setBounds(0,0,500,450);
