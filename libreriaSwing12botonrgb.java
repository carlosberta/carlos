...
import java.awt.*;
public class libreriaSwing12botonrgb extends JFrame implements ActionListener {
    private JLabel label1, label2, label3;
    private JComboBox combo1, combo2, combo3;
    private JButton boton1;

    public libreriaSwing12botonrgb(){
        setLayout(null);
    ...
    public static void main(String args[]){
        libreriaSwing12botonrgb formulario1 = new libreriaSwing12botonrgb();
